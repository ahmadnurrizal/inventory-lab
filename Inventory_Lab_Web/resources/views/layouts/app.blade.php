...
<html lang="en" dir="ltr">
  ...
  <body style="min-height:100vh">
    ...
    <div id="mySidebar" class="sidebar">
      <a class="text-center p-0" style="margin-bottom:50px;margin-top: 30px;border:none;"><h1 style="color:white">LOGO</h1></a>
      <ul style="padding-left:0px">
        <li><a href="{{route('admin.dashboard')}}" class="{{ (request()->is('admin/dashboard*')) ? 'active' : '' }}"><i class="bi bi-house"></i>&nbsp;&nbsp;&nbsp;Dashboard</a></li>
